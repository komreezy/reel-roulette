...
export type Movie = MovieDetails & { id: string; title: string; year?: number; summary?: string; runtimeMinutes?: number; contentRating?: string; genres: string[]; watched: boolean; rating?: number; audienceRating?: number; thumb?: string; art?: string; demoArtwork?: string; plexKey: string; libraryKey: string; libraryTitle?: string; machineIdentifier?: string; source?: "plex" | "letterboxd"; externalUrl?: string };
